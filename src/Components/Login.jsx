      ...
      <div className='bg-[#252525] px-12 py-16 rounded-[20px]'>
        ...
        <div className='mt-8' >
            <button onClick={() => {
                    ...
                    }} className='w-[360px] flex gap-4 justify-center items-center px-4 py-2.5 rounded-full border border-1 border-[#f1f3f515] text-smd hover:bg-[#f1f3f505]'> Log In with Google</button>
        </div>
